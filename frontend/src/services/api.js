...
const API_URL = import.meta.env.VITE_API_URL || 'https://ai-powered-career-recommendation-system-2.onrender.com';
...
export const authAPI = {
  ...
  updateGoal: (career_goal) => api.put('/auth/profile/update', { career_goal }),
};
